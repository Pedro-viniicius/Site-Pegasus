...
import girocopteros from '../../assets/montagemColagem.png'
import girocopteross from '../../assets/MaskGroup.png'
import girocopterosss from '../../assets/021.png'
import vectorVermelho from '../../assets/Vector_vermelho.png'
import Exlusividade from '../../assets/Exclusividade.png'
import Seguranca from '../../assets/Seguranca.png'
import Atendimento from '../../assets/Atendimento.png'
import Pater from '../../assets/PATTERN.png'
import logo from '../../assets/LOGOTIPO1 1.png'
import email from '../../assets/email.png'
import local from '../../assets/Local.png'
import tel from '../../assets/bi_telephone-fill.png'
import whats from '../../assets/Icone_Whatsapp.png'
import face from '../../assets/Icone_Facebook.png'
    ...
    return (
        <div className="Home">
            ...
            <div className="conteudo-principal">
                <section className="sessao_um">
                    <div className="apresentacao">
                        <h1><strong>Pegasus:</strong>Nossa missão é
                            elevar você a novos horizontes
                ...
                <section className="sessao_dois">
                    ...
                    <div className="sobre_pegasus">
                        ...
                        <h3>A Pegasus surgiu com a missão de oferecer produtos de alta qualidade e preços acessíveis, atendendo
                            ...
                            Com um sistema logístico otimizado e estratégias de precificação inteligente, a empresa cresceu rapidamente,
                            conquistando clientes fiéis e expandindo sua presença no mercado.

                            A agilidade no reabastecimento e a diversificação do portfólio foram fundamentais para esse sucesso, permitindo
                            atender desde pequenos negócios até grandes distribuidores. Hoje, a Pegasus se consolida como referência no setor,
                            mantendo o compromisso com inovação e eficiência.</h3>
